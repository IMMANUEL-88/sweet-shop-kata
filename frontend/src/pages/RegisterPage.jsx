  ...
  return (
    <div className="flex min-h-screen bg-pink-200 relative">
      ...
      <div className="hidden lg:flex w-1/2 bg-pink-600 text-white flex-col justify-center items-center px-12 relative overflow-hidden">
        ...
        {/* Foreground content */}
        <h1 className="text-4xl font-bold mb-4 relative z-10">Join the Sweet Fun!</h1>
        <p className="text-xl mb-6 relative z-10">🍬 A world of treats awaits you!</p>
        <p className="max-w-md text-center text-md leading-relaxed relative z-10">
          Sign up to begin your delicious journey with us. Let's make life a little sweeter, one candy at a time.
        </p>
      ...
      {/* Right side (Register form, also used in mobile full-screen) */}
